      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-3 flex flex-col sm:flex-row lg:flex-col gap-5 justify-between">
          ...
          <div className="flex-1 bg-[#0f0c1b]/80 backdrop-blur-md rounded-2xl p-5 border border-cyan-500/50 shadow-[0_0_20px_rgba(6,182,212,0.25)] hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] transition-all duration-300 relative overflow-hidden">
            <div className="h-20 bg-slate-900/80 rounded-xl mb-3 border border-cyan-500/20 overflow-hidden relative flex flex-col items-center justify-center">
              <div className="absolute inset-0 bg-linear-to-r from-orange-500/20 via-purple-500/20 to-cyan-500/20 animate-pulse" />
              <p className="text-xs font-bold text-cyan-300 relative z-10">⚡ Become a Seller</p>
              <p className="text-[10px] text-slate-400 mt-1 relative z-10">Grow your business with us</p>
            </div>
            <Link to="/supplier-dashboard" className="block text-center w-full py-1.5 rounded-lg bg-linear-to-r from-cyan-500 to-blue-600 text-white text-xs font-bold shadow-[0_0_12px_rgba(6,182,212,0.4)]">
              Register Store
            </Link>
          </div>
